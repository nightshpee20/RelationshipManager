...
CALL sp_insertUserAcquaintance(1, 'Georgi', 'Georgiev', 'M', 1, 4, '', 1); #pld
CALL sp_insertUserAcquaintance(1, 'Nikola', 'Nikolov', 'M', 2, 1, '', 2); #vrn
CALL sp_insertUserAcquaintance(1,'Vanesa', 'Vanesova', 'F', 1, 6, '', 2); #stz
CALL sp_insertUserAcquaintance(1, 'Elena', 'Elenova', 'F', 7, 3, '', 5); #sfa
